...
`)}function at(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let r=0;r<e.length;r++)if(e[r]===`\\`)r++;else if(e[r]===t[0])n++;else if(e[r]===t[1]&&(n--,n<0))return r;return n>0?-2:-1}function ot(e,t=0){let n=t,r=``;for(let t of e)if(t===`	`){let e=4-n%4;r+=` `.repeat(e),n+=e}else r+=t,n++;return r}function st(e,t,n,r,i){let a=t.href,o=t.title||null,s=e[1].replace(i.other.outputLinkReplace,`$1`),c=e[0].charAt(0)===`!`;r.state.inLink=!0;let l=r.state.linkEmitted,u=r.state.inRawBlock;r.state.linkEmitted=!1;let d=r.inlineTokens(s),ee=r.state.linkEmitted;if(r.state.linkEmitted=l,r.state.inLink=!1,!c){if(ee){r.state.inRawBlock=u;return}r.state.linkEmitted=!0}return{type:c?`image`:`link`,raw:n,href:a,title:o,text:s,tokens:d}}function ct(e,t,n){let r=e.match(n.other.indentCodeCompensation);if(r===null)return t;let i=r[1];return t.split(`
...
inchangés.
`,dt=d({load:()=>pt,prerender:()=>!0}),ft=e=>e.toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/[^a-z0-9]+/g,`-`).replace(/^-|-$/g,``);function pt(){let e=[];$.use({renderer:{heading({tokens:t,depth:n}){let r=this.parser.parseInline(t),i=t.map(e=>e.raw).join(``),a=ft(i);return n===2&&e.push({id:a,text:i}),`<h${n} id="${a}">${r}</h${n}>\n`}},gfm:!0});let t=ut.slice(ut.indexOf(`
## `));return{html:$.parse(t),toc:e}}var mt=h(`<meta name="description" content="Plan de cours POL-2000 Méthodologie quantitative, Université Laval, automne 2026."/> <link rel="icon" type="image/svg+xml"/>`,1),ht=h(`<li class="svelte-1oh9q7c"><a class="svelte-1oh9q7c"> </a></li>`),gt=h(`<!> <main class="svelte-1oh9q7c"><header class="tete svelte-1oh9q7c"><p class="sur monte svelte-1oh9q7c"> </p> <h1 class="monte svelte-1oh9q7c">Plan de cours</h1> <hr class="filet monte"/> <p class="lead monte"> </p> <div class="actions monte svelte-1oh9q7c"><a class="bouton plein" rel="noopener">Télécharger le PDF <span class="fl">↓</span></a> <a class="bouton">Retour au site <span class="fl">→</span></a></div></header> <div class="corps svelte-1oh9q7c"><nav class="sommaire svelte-1oh9q7c" aria-label="Sommaire"><p class="etiq gris">Sommaire</p> <ol class="svelte-1oh9q7c"></ol></nav> <article class="prose svelte-1oh9q7c"></article></div></main> <!>`,1);function _t(d,h){f(h,!0);let y=[{href:`${_}/#seances`,texte:`Séances`},{href:`${_}/#evaluations`,texte:`Évaluations`},{href:`${_}/${re.syllabusPdf}`,texte:`PDF`,phare:!0}];var b=gt();ee(`1oh9q7c`,e=>{var i=mt(),c=r(s(i),2);a(()=>m(c,`href`,`${_??``}/img/pol2000_logo.svg`)),n(()=>{t.title=`Plan de cours · POL-2000 · Automne 2026`}),o(e,i)});var x=s(b);ie(x,{get liens(){return y},retour:!0});var S=r(x,2),C=i(S),w=i(C),oe=c(w),T=r(w,6),se=c(T),E=r(T,2),D=i(E),O=r(D,2);u(E),u(C);var k=r(C,2),A=i(k),j=r(i(A),2);l(j,21,()=>h.data.toc,ne,(e,t)=>{var n=ht(),r=i(n),s=c(r,!0);u(n),a(()=>{m(r,`href`,`#${te(t).id??``}`),g(s,te(t).text)}),o(e,n)}),u(j),u(A);var M=r(A,2);p(M,()=>h.data.html,!0),u(M),u(k),u(S);var ce=r(S,2);ae(ce,{}),a(()=>{g(oe,`${v.sigle??``} · ${v.session??``} · NRC ${v.nrc??``}`),g(se,`${v.titre??``}. Université Laval, Faculté des sciences sociales, Département de science politique. Le ${v.jour??``}, de ${v.heures??``}, au ${v.local??``}.`),m(D,`href`,`${_??``}/${re.syllabusPdf??``}`),m(O,`href`,`${_??``}/`)}),o(d,b),e()}export{_t as component,dt as universal};