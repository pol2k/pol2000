...
inchangés.
`,dt=ee({load:()=>pt,prerender:()=>!0}),ft=e=>e.toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/[^a-z0-9]+/g,`-`).replace(/^-|-$/g,``);function pt(){let e=[];$.use({renderer:{heading({tokens:t,depth:n}){let r=this.parser.parseInline(t),i=t.map(e=>e.raw).join(``),a=ft(i);return n===2&&e.push({id:a,text:i}),`<h${n} id="${a}">${r}</h${n}>\n`}},gfm:!0});let t=ut.slice(ut.indexOf(`
## `));return{html:$.parse(t),toc:e}}var mt=h(`<meta name="description" content="Plan de cours POL-2000 Méthodologie quantitative, Université Laval, automne 2026."/> <link rel="icon" type="image/svg+xml"/>`,1),ht=h(`<li class="svelte-1oh9q7c"><a class="svelte-1oh9q7c"> </a></li>`),gt=h(`<!> <main class="svelte-1oh9q7c"><header class="tete svelte-1oh9q7c"><p class="sur monte svelte-1oh9q7c"> </p> <h1 class="monte svelte-1oh9q7c">Plan de cours</h1> <hr class="filet monte"/> <p class="lead monte"> </p> <div class="actions monte svelte-1oh9q7c"><a class="bouton plein" rel="noopener">Télécharger le PDF <span class="fl">↓</span></a> <a class="bouton">Retour au site <span class="fl">→</span></a></div></header> <div class="corps svelte-1oh9q7c"><nav class="sommaire svelte-1oh9q7c" aria-label="Sommaire"><p class="etiq gris">Sommaire</p> <ol class="svelte-1oh9q7c"></ol></nav> <article class="prose svelte-1oh9q7c"></article></div></main> <!>`,1);function _t(ee,h){e(h,!0);let y=[{href:`${_}/#seances`,texte:`Séances`},{href:`${_}/#evaluations`,texte:`Évaluations`},{href:`${_}/${re.syllabusPdf}`,texte:`PDF`,phare:!0}];var b=gt();d(`1oh9q7c`,e=>{var t=mt(),a=l(n(t),2);r(()=>m(a,`href`,`${_??``}/img/pol2000_logo.svg`)),i(()=>{ne.title=`Plan de cours · POL-2000 · Automne 2026`}),o(e,t)});var x=n(b);ie(x,{get liens(){return y},retour:!0});var S=l(x,2),C=c(S),w=c(C),oe=s(w),T=l(w,6),se=s(T),E=l(T,2),D=c(E),O=l(D,2);p(E),p(C);var k=l(C,2),A=c(k),j=l(c(A),2);u(j,21,()=>h.data.toc,te,(e,n)=>{var i=ht(),a=c(i),l=s(a,!0);p(i),r(()=>{m(a,`href`,`#${t(n).id??``}`),g(l,t(n).text)}),o(e,i)}),p(j),p(A);var M=l(A,2);f(M,()=>h.data.html,!0),p(M),p(k),p(S);var ce=l(S,2);ae(ce,{}),r(()=>{g(oe,`${v.sigle??``} · ${v.session??``} · NRC ${v.nrc??``}`),g(se,`${v.titre??``}. Université Laval, Faculté des sciences sociales, Département de science politique. Le ${v.jour??``}, de ${v.heures??``}, au ${v.local??``}.`),m(D,`href`,`${_??``}/${re.syllabusPdf??``}`),m(O,`href`,`${_??``}/`)}),o(ee,b),a()}export{_t as component,dt as universal};